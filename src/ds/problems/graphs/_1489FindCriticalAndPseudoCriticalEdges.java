...
public class _1489FindCriticalAndPseudoCriticalEdges {
    ...
    public static void main(String[] args) {
        _1489FindCriticalAndPseudoCriticalEdges findCriticalAndPseudoCriticalEdges = new _1489FindCriticalAndPseudoCriticalEdges();
        int[][] edges = {
                {0,1,1},
                {1,2,1},
                {2,3,2},
        ...
        findCriticalAndPseudoCriticalEdges.findCriticalAndPseudoCriticalEdges(5,edges);
    }
